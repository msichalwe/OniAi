...
show_usage() {
    cat << EOF
clawlog - OniAI Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View OniAI logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    OniAI logs flow through the macOS unified log (subsystem: ai.oni).
