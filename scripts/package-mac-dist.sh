...
# Output:
# - dist/OniAI.app
# - dist/OniAI-<version>.zip
# - dist/OniAI-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.oni.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/OniAI.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OniAI-$VERSION.zip"
DMG="$ROOT_DIR/dist/OniAI-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OniAI-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OniAI-$VERSION.dSYM.zip"
