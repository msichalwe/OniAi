...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@oni", { botUsername: "oni" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@oni args", {
        botUsername: "oni",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "oni" })).toBe(
      "/help@otherbot",
    );
  });
