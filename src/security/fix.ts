...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OniAIConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OniAIConfig; env: NodeJS.ProcessEnv }): {
  cfg: OniAIConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
