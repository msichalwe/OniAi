...
export type ChannelAgentToolFactory = (params: { cfg?: OniAIConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OniAIConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OniAIConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OniAIConfig }) => boolean;
  supportsCards?: (params: { cfg: OniAIConfig }) => boolean;
