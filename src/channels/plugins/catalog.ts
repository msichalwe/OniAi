...
import { discoverOniAIPlugins } from "../../plugins/discovery.js";
import type { OniAIPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, OniAIPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["ONI_PLUGIN_CATALOG_PATHS", "ONI_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<OniAIPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: OniAIPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverOniAIPlugins({ workspaceDir: options.workspaceDir });
