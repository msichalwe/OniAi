...
export function listChannelMessageActions(cfg: OniAIConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OniAIConfig): boolean {
...
export function supportsChannelMessageCards(cfg: OniAIConfig): boolean {
