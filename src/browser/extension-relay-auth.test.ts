...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated oni relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedOniAIRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-oni-relay-token",
