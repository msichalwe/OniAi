...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/oni/oni/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.ONI_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.oni/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: OniAIConfig = {
    ...params.cfg,
