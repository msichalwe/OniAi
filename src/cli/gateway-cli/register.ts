      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["oni gateway run", "Run the gateway in the foreground."],
            ["oni gateway status", "Show service status and probe reachability."],
            ["oni gateway discover", "Find local and wide-area gateway beacons."],
            ["oni gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.oni.ai/cli/gateway")}\n`,
      ),
  );
