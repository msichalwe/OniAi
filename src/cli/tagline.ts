const DEFAULT_TAGLINE = "All your chats, one OniAI.";
...
const TAGLINES: string[] = [
  ...
  "Locked in, commit ready—let's ship something mildly responsible.",
  "I'll streamline your workflow like a well-tuned pipeline: fast, clean, effective.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.ONI_TAGLINE_INDEX;
