    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["oni channels list", "List configured channels and auth profiles."],
          ["oni channels status --probe", "Run channel status checks and probes."],
          [
            "oni channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["oni channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.oni.ai/cli/channels",
        )}\n`,
    );
