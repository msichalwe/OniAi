    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["oni directory self --channel slack", "Show the connected account identity."],
          [
            'oni directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["oni directory groups list --channel discord", "List available groups/channels."],
          [
            "oni directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.oni.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
