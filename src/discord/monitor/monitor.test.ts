...
describe("agent components", () => {
  const createCfg = (): OniAIConfig => ({}) as OniAIConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/oni-sessions-test.json");
  });
