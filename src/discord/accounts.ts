...
function mergeDiscordAccountConfig(cfg: OniAIConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: OniAIConfig): ResolvedDiscordAccount[] {
