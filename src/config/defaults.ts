...
function resolveAnthropicDefaultAuthMode(cfg: OniAIConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OniAIConfig): OniAIConfig {
...
export function applyTalkApiKey(config: OniAIConfig): OniAIConfig {
...
export function applyTalkConfigNormalization(config: OniAIConfig): OniAIConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: OniAIConfig): OniAIConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OniAIConfig): OniAIConfig {
...
export function applyLoggingDefaults(cfg: OniAIConfig): OniAIConfig {
...
export function applyContextPruningDefaults(cfg: OniAIConfig): OniAIConfig {
...
export function applyCompactionDefaults(cfg: OniAIConfig): OniAIConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
