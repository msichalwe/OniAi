...
import type { InteractiveConfig } from "./types.interactive.js";
...
export type OniAIConfig = {
  meta?: {
    /** Last OniAI version that wrote this config. */
  ...
  ui?: {
    /** Accent color for OniAI UI chrome (hex). */
    seamColor?: string;
    assistant?: {
