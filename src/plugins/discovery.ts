...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @oni/voice-call -> voice-call).
...
export function discoverOniAIPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".oni", "extensions")];
