...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/oni/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/oni/extensions",
        global: "/Users/x/.oni/extensions",
        workspace: "/Users/x/ws/.oni/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.oni/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/oni/extensions",
        global: "/Users/x/.oni/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.oni/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/oni/extensions",
        global: "/Users/x/.oni/extensions",
