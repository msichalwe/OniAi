...
export type OniAIPluginConfigSchema = {
...
export type OniAIPluginToolContext = {
  config?: OniAIConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type OniAIPluginToolFactory = (
  ctx: OniAIPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OniAIPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OniAIPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<OniAIConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type OniAIPluginGatewayMethod = {
  method: string;
 ...
 */
export type OniAIPluginCommandDefinition = {
...
export type OniAIPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type OniAIPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type OniAIPluginCliContext = {
  program: Command;
  config: OniAIConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type OniAIPluginCliRegistrar = (ctx: OniAIPluginCliContext) => void | Promise<void>;

export type OniAIPluginServiceContext = {
  config: OniAIConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type OniAIPluginService = {
  id: string;
  start: (ctx: OniAIPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: OniAIPluginServiceContext) => void | Promise<void>;
};

export type OniAIPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type OniAIPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: OniAIPluginConfigSchema;
  register?: (api: OniAIPluginApi) => void | Promise<void>;
  activate?: (api: OniAIPluginApi) => void | Promise<void>;
};

export type OniAIPluginModule =
  | OniAIPluginDefinition
  | ((api: OniAIPluginApi) => void | Promise<void>);

export type OniAIPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | OniAIPluginToolFactory,
    opts?: OniAIPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: OniAIPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: OniAIPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: OniAIPluginHttpRouteHandler }) => void;
  registerChannel: (registration: OniAIPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: OniAIPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: OniAIPluginService) => void;
   ...
   */
  registerCommand: (command: OniAIPluginCommandDefinition) => void;
