...
export function listWhatsAppAuthDirs(cfg: OniAIConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OniAIConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OniAIConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OniAIConfig): ResolvedWhatsAppAccount[] {
