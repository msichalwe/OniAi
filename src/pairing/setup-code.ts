...
function resolveGatewayPort(cfg: OniAIConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: OniAIConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
