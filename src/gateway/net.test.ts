...
describe("resolveHostName", () => {
  it("normalizes IPv4/hostname and IPv6 host forms", () => {
    const cases = [
      { input: "localhost:19100", expected: "localhost" },
      { input: "127.0.0.1:19100", expected: "127.0.0.1" },
      { input: "[::1]:19100", expected: "::1" },
      { input: "::1", expected: "::1" },
    ] as const;
...
describe("isLocalishHost", () => {
  ...
  it("rejects non-local hosts", () => {
    const rejected = ["example.com", "192.168.1.10", "203.0.113.5:19100"];
...
describe("isSecureWebSocketUrl", () => {
  it("accepts secure websocket/loopback ws URLs and rejects unsafe inputs", () => {
    const cases = [
      { input: "wss://127.0.0.1:19100", expected: true },
      { input: "wss://localhost:19100", expected: true },
      { input: "wss://remote.example.com:19100", expected: true },
      { input: "wss://192.168.1.100:19100", expected: true },
      { input: "ws://127.0.0.1:19100", expected: true },
      { input: "ws://localhost:19100", expected: true },
      { input: "ws://[::1]:19100", expected: true },
      { input: "ws://127.0.0.42:19100", expected: true },
      { input: "ws://remote.example.com:19100", expected: false },
      { input: "ws://192.168.1.100:19100", expected: false },
      { input: "ws://10.0.0.5:19100", expected: false },
      { input: "ws://100.64.0.1:19100", expected: false },
      { input: "not-a-url", expected: false },
      { input: "", expected: false },
      { input: "http://127.0.0.1:19100", expected: false },
      { input: "https://127.0.0.1:19100", expected: false },
    ] as const;
