...
export function buildGatewayConnectionDetails(
  options: { config?: OniAIConfig; url?: string; configPath?: string } = {},
  ...
  if (!isSecureWebSocketUrl(url)) {
    throw new Error(
      [
        ...
        "- keep gateway.bind=loopback and use an SSH tunnel (ssh -N -L 19100:127.0.0.1:19100 user@gateway-host)",
        "- or use Tailscale Serve/Funnel for HTTPS remote access",
        "Doctor: oni doctor --fix",
