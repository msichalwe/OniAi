...
export function resolveGatewayReloadSettings(cfg: OniAIConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  ...
  onHotReload: (plan: GatewayReloadPlan, nextConfig: OniAIConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: OniAIConfig) => void;
  log: {
  ...
  const queueRestart = (plan: GatewayReloadPlan, nextConfig: OniAIConfig) => {
    if (restartQueued) {
      return;
    }
    restartQueued = true;
