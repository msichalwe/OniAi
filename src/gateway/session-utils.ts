...
import { type OniAIConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OniAIConfig): string[] {
...
export function listAgentsForGateway(cfg: OniAIConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OniAIConfig): string {
...
function resolveSessionStoreAgentId(cfg: OniAIConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OniAIConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OniAIConfig): GatewaySessionsDefaults {
