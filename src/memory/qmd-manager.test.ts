...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: OniAIConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__oniMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__oniMcporterColdStartWarned;
  });
