...
export const DEFAULT_SANDBOX_IMAGE = "oni-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "oni-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "oni-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "oni-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "oni-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "oni-sandbox-browser";
