...
function resolveWatchPaths(workspaceDir: string, config?: OniAIConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OniAIConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OniAIConfig }) {
