...
const CLEANUP_STATE_KEY = Symbol.for("oni.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("oni.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("oni.sessionWriteLockWatchdogState");
