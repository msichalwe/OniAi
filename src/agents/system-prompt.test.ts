...
describe("buildAgentSystemPrompt", () => {
  ...
  it("omits extended sections in minimal prompt mode", () => {
    ...
    expect(prompt).toContain("Do not self-replicate");
  ...
  it("includes safety guardrails in full prompts", () => {
    ...
    expect(prompt).toContain("Comply with stop/pause/audit requests");
    expect(prompt).toContain("Do not self-replicate");
    expect(prompt).toContain("When the OWNER asks you to do something, DO IT");
  });
  ...
  it("includes a CLI quick reference section", () => {
    ...
    expect(prompt).toContain("## OniAI CLI Quick Reference");
    expect(prompt).toContain("oni gateway restart");
  ...
  it("preserves tool casing in the prompt", () => {
    ...
    expect(prompt).toContain("OniAI docs: /tmp/oni/docs");
    expect(prompt).toContain(
  ...
  it("adds ClaudeBot self-update guidance when gateway tool is available", () => {
    ...
    expect(prompt).toContain("## OniAI Self-Update");
  ...
  it("describes sandboxed runtime and elevated when allowed", () => {
    ...
    expect(prompt).toContain(
      "For read/write/edit/apply_patch, file paths resolve against host workspace: /tmp/oni. For bash/exec commands, use sandbox container paths under /workspace (or relative paths from that workdir), not host paths.",
    );
