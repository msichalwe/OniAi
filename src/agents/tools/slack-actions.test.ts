...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): OniAIConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: OniAIConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: OniAIConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
