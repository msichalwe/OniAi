...
function resolveMemoryToolContext(options: { config?: OniAIConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: OniAIConfig): MemoryCitationsMode {
