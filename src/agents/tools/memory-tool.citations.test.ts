...
function asOniAIConfig(config: Partial<OniAIConfig>): OniAIConfig {
  return config as OniAIConfig;
}

function createToolConfig() {
  return asOniAIConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: OniAIConfig = createToolConfig()) {
