...
function resolveAdaptiveReadMaxBytes(options?: OniAIReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOniAIReadTool(base, {
...
export function createOniAIReadTool(
  base: AnyAgentTool,
  options?: OniAIReadToolOptions,
): AnyAgentTool {
