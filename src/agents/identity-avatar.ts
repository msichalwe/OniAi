...
function resolveAvatarSource(cfg: OniAIConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OniAIConfig, agentId: string): AgentAvatarResolution {
