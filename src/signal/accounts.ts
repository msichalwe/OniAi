...
function mergeSignalAccountConfig(cfg: OniAIConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OniAIConfig): ResolvedSignalAccount[] {
