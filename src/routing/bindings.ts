...
export function listBindings(cfg: OniAIConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: OniAIConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OniAIConfig) {
