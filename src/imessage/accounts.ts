...
function mergeIMessageAccountConfig(cfg: OniAIConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OniAIConfig): ResolvedIMessageAccount[] {
