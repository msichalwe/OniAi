...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.ONI_STATE_DIR;
  const configPath = env.ONI_CONFIG_PATH;
  ...
  return {
    ...
    ONI_PROFILE: profile,
    ONI_STATE_DIR: stateDir,
    ONI_CONFIG_PATH: configPath,
    ONI_GATEWAY_PORT: String(port),
    ONI_GATEWAY_TOKEN: token,
    ONI_LAUNCHD_LABEL: resolvedLaunchdLabel,
    ONI_SYSTEMD_UNIT: systemdUnit,
    ONI_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    ONI_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    ONI_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    ONI_STATE_DIR: stateDir,
    ONI_CONFIG_PATH: configPath,
    ONI_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    ONI_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    ONI_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    ONI_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    ONI_LOG_PREFIX: "node",
    ONI_SERVICE_MARKER: NODE_SERVICE_MARKER,
    ONI_SERVICE_KIND: NODE_SERVICE_KIND,
    ONI_SERVICE_VERSION: VERSION,
  };
}
