...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.oni.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ONI_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.oni.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ONI_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.oni.gateway.plist",
    },
    {
      name: "uses profile-specific label when ONI_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ONI_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.oni.jbphoenix.plist",
    },
    {
      name: "prefers ONI_LAUNCHD_LABEL over ONI_PROFILE",
      env: {
        HOME: "/Users/test",
        ONI_PROFILE: "jbphoenix",
        ONI_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from ONI_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ONI_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ONI_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ONI_PROFILE: "myprofile",
        ONI_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.oni.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
