...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.ONI_TTS_PREFS;
      process.env.ONI_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.ONI_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: OniAIConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
