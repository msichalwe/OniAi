...
import type { OniAIConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: OniAIConfig, agentId: string) {
  try {
