...
export const A2UI_PATH = "/__oni__/a2ui";

export const CANVAS_HOST_PATH = "/__oni__/canvas";

export const CANVAS_WS_PATH = "/__oni__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.oniCanvasA2UIAction.postMessage(...)
  // - Android: window.oniCanvasA2UIAction.postMessage(...)
  const handlerNames = ["oniCanvasA2UIAction"];
  ...
  globalThis.OniAI = globalThis.OniAI ?? {};
  globalThis.OniAI.postMessage = postToNode;
  globalThis.OniAI.sendUserAction = sendUserAction;
  globalThis.oniPostMessage = postToNode;
  globalThis.oniSendUserAction = sendUserAction;
