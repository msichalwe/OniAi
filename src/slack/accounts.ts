...
function mergeSlackAccountConfig(cfg: OniAIConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OniAIConfig): ResolvedSlackAccount[] {
