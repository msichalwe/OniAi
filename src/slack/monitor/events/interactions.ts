...
// Prefix for OniAI-generated action IDs to scope our handler
const ONI_ACTION_PREFIX = "oni:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${ONI_ACTION_PREFIX}`);

  // Handle OniAI modal submissions with callback_ids scoped by our prefix.
