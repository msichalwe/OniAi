...
describe("system-presence version fallback", () => {
  it("uses ONI_SERVICE_VERSION when ONI_VERSION is not set", async () => {
  ...
  it("prefers ONI_VERSION over ONI_SERVICE_VERSION", async () => {
    await withPresenceModule(
      {
  ...
  it("uses npm_package_version when ONI_VERSION and ONI_SERVICE_VERSION are blank", async () => {
    await withPresenceModule(
      {
        ONI_VERSION: " ",
        ONI_SERVICE_VERSION: "\t",
