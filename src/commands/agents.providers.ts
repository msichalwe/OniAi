...
function resolveDefaultAccountId(cfg: OniAIConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OniAIConfig): boolean {
...
export function summarizeBindings(cfg: OniAIConfig, bindings: AgentBinding[]): string[] {
