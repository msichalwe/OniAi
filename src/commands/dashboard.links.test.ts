...
function mockSnapshot(token = "abc") {
  ...
  resolveGatewayPortMock.mockReturnValue(19100);
  resolveControlUiLinksMock.mockReturnValue({
    httpUrl: "http://127.0.0.1:19100/",
    wsUrl: "ws://127.0.0.1:19100",
  });
}
...
describe("dashboardCommand", () => {
  ...
  it("opens and copies the dashboard link by default", async () => {
    ...
    expect(copyToClipboardMock).toHaveBeenCalledWith("http://127.0.0.1:19100/#token=abc123");
    expect(openUrlMock).toHaveBeenCalledWith("http://127.0.0.1:19100/#token=abc123");
