...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.oni.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("oni hooks list")}`,
      `  ${formatCliCommand("oni hooks enable <name>")}`,
      `  ${formatCliCommand("oni hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
