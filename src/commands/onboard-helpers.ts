...
export function summarizeExistingConfig(config: OniAIConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.oni.ai/gateway/remote",
    "https://docs.oni.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
