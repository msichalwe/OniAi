...
This directory contains the **BlueBubbles external channel plugin** for OniAI.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `oni/plugin-sdk` helpers.
