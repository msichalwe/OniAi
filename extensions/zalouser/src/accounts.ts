...
export function listZalouserAccountIds(cfg: OniAIConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OniAIConfig): string {
...
function mergeZalouserAccountConfig(cfg: OniAIConfig, accountId: string): ZalouserAccountConfig {
