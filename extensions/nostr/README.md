...
Nostr DM channel plugin for OniAI using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OniAI. It enables your bot to:
...
# Configure oni to use local relay
