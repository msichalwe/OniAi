...
import { isWSL2Sync } from "oni/plugin-sdk";

const CLIENT_ID_KEYS = ["ONI_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
const CLIENT_SECRET_KEYS = [
  "ONI_GEMINI_OAUTH_CLIENT_SECRET",
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to OniAI.</p></body></html>",
        );
