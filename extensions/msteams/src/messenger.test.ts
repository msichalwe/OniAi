...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "oni/plugin-sdk";
...
import { resolvePreferredOniAITmpDir } from "../../../src/infra/tmp-oni-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredOniAITmpDir(), "msteams-mention-"));
