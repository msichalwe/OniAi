...
export function listGoogleChatAccountIds(cfg: OniAIConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OniAIConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OniAIConfig): ResolvedGoogleChatAccount[] {
