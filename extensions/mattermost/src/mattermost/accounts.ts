...
export function listMattermostAccountIds(cfg: OniAIConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OniAIConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OniAIConfig): ResolvedMattermostAccount[] {
