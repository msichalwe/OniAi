...
import type { ReplyPayload, OniAIConfig } from "oni/plugin-sdk";
import { createReplyPrefixOptions } from "oni/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OniAIConfig;
