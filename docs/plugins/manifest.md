...
read_when:
  - You are building a OniAI plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (oni.plugin.json)

Every plugin **must** ship a `oni.plugin.json` file in the **plugin root**.
OniAI uses this manifest to validate configuration **without executing plugin
