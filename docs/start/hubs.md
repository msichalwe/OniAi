---
summary: "Hubs that link to every OniAI doc"
read_when:
...
<Note>
If you are new to OniAI, start with [Getting Started](/start/getting-started).
</Note>
...
- [Wizard](/start/wizard)
- [Setup](/start/setup)
- [Dashboard (local Gateway)](http://127.0.0.1:19100/)
- [Help](/help)
- [Docs directory](/start/docs-directory)
- [Configuration](/gateway/configuration)
- [Configuration examples](/gateway/configuration-examples)
- [OniAI assistant](/start/oni)
