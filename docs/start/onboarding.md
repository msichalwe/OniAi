---
summary: "First-run onboarding flow for OniAI (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OniAI">
...
<Step title="CLI">
  ...
  The app can install the global `oni` CLI via npm/pnpm so terminal
