---
summary: "Overview of OniAI onboarding options and flows"
read_when:
...
OniAI supports multiple onboarding paths depending on where the Gateway runs
...
- [`oni onboard` command](/cli/onboard)

## macOS app onboarding

Use the OniAI app when you want a fully guided setup on macOS. Docs:
