...
OniAI ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OniAI also aligns
the install method:
...
When you switch channels with `oni update`, OniAI also syncs plugin sources:
