...
- Install via CLI: `oni plugins install @oni/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `oni plugins install ./extensions/zalo`
   - From npm (if published): `oni plugins install @oni/zalo`
...
- Approve via:
  - `oni pairing list zalo`
  - `oni pairing approve zalo <CODE>`
...
- Example: `oni message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `oni channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `oni logs --follow`
