...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OniAI HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `oni pairing approve slack <code>`.
...
OniAI supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, OniAI falls back to normal delivery for remaining payloads.
