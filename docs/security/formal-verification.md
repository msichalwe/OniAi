...
summary: Machine-checked security models for OniAI’s highest-risk paths.
read_when:
...
This page tracks OniAI’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that OniAI enforces its
...
**What this is not (yet):** a proof that “OniAI is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/oni-formal-models](https://github.com/vignesh07/oni-formal-models).
...
```bash
git clone https://github.com/vignesh07/oni-formal-models
cd oni-formal-models
