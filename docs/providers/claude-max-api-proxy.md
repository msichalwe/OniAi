...
You can point OniAI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OniAI
...
- [Anthropic provider](/providers/anthropic) - Native OniAI integration with Claude setup-token or API keys
