---
summary: "Use Synthetic's Anthropic-compatible API in OniAI"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OniAI registers it as the
...
Note: OniAI's Anthropic client appends `/v1` to the base URL, so use
