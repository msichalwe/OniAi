...
Deepgram is a speech-to-text API. In OniAI it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, OniAI uploads the audio file to Deepgram and injects the transcript
