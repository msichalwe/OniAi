---
summary: "Use NVIDIA's OpenAI-compatible API in OniAI"
read_when:
  - You want to use NVIDIA models in OniAI
...
oni onboard --auth-choice skip
oni models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
