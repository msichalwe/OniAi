---
summary: "Use Qianfan's unified API to access many models in OniAI"
read_when:
...
3. OniAI installed on your system
...
4. Copy the API key for use with OniAI

## CLI setup

```bash
oni onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OniAI Configuration](/gateway/configuration)
