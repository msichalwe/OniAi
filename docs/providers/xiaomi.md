---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OniAI"
read_when:
  - You want Xiaomi MiMo models in OniAI
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OniAI uses
