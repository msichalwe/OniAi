const PORT_GUIDANCE = 'Use gateway port + 3 (for gateway 19100, relay is 18792).'
...
export function classifyRelayCheckException(err, port) {
  ...
  return {
    kind: 'error',
    message: `Relay not reachable/authenticated at http://127.0.0.1:${port}/. Start OniAI browser relay and verify token.`,
  }
}
